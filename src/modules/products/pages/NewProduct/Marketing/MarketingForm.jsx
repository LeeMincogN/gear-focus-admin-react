        ...
        <Box component="form" sx={{ margin: '0 auto', width: '600px' }}>
          <Grid container spacing={3}>
            ...
            <Grid item xs={9} sx={{ display: 'flex' }}>
              <SelectField name="open" valueList={values} defaultValue="Autogenerated" />
            </Grid>
            <Grid item xs={3} sx={{ margin: 'auto 0' }}>
              <label htmlFor="meta">Meta description</label>
            </Grid>
            <Grid item xs={9} sx={{ display: 'flex' }}>
              <SelectField name="meta" valueList={values} defaultValue="Autogenerated" />
            </Grid>
            <Grid item xs={3} sx={{ margin: 'auto 0' }}>
            ...
            <Grid item xs={9} sx={{ display: 'flex' }}>
              <InputField name="product" text="Leave blank to use product name as Page Title." />
            </Grid>
            <Grid item xs={3} sx={{ margin: 'auto 0' }}>
